"""
CTD -- Cell Type Decodability.

Does the latent encode cell identity? Linear softmax probe: latent -> cell_type.
Metrics: Accuracy, macro-F1 (evaluated on the val split).
"""
import argparse
import os
import sys
...
def main():
    ...
    args = ap.parse_args()
    run_classification("CTD", args.label_col, args.train_emb, args.val_emb, args.probe)
