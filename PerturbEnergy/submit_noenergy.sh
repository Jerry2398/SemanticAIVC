...
: "${STEPS:=100000}"; OVERRIDES="model.use_energy=false train.out_dir=/scratch/Projects/CFP-03/CFP03-CF-130/yuchen.yan/models/pe_noenergy"
nvidia-smi
