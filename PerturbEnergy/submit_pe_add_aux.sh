...
: "${STEPS:=100000}"; OVERRIDES="model.fusion=add model.use_energy=false loss.aux_ce_weight=100 train.out_dir=/scratch/Projects/CFP-03/CFP03-CF-130/yuchen.yan/models/pe_add_aux100"
nvidia-smi
