...
#PBS -j oe
#PBS -o logs/train_g2_anticol.out
...
: "${STEPS:=100000}"; OVERRIDES="loss.energy_elbo_weight=0.1 loss.beta_kl_a=2.0 train.out_dir=/scratch/Projects/CFP-03/CFP03-CF-130/yuchen.yan/models/perturbenergy_anticol"
nvidia-smi
