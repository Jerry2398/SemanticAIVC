...
: "${STEPS:=100000}"; OVERRIDES="optim.energy_l2_reg=0.1 loss.energy_elbo_weight=0.1 loss.beta_kl_a=2.0 train.out_dir=/scratch/Projects/CFP-03/CFP03-CF-130/yuchen.yan/models/perturbenergy_both"
nvidia-smi
