...
#PBS -j oe
#PBS -o logs/train_c1_pair05.out
...
: "${STEPS:=100000}"; OVERRIDES="optim.energy_l2_reg=0.1 loss.contrast_mode=pair     loss.contrast_weight=0.5 train.out_dir=/scratch/Projects/CFP-03/CFP03-CF-130/yuchen.yan/models/pe_con_pair05"
nvidia-smi
