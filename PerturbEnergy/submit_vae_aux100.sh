...
#PBS -j oe
#PBS -o logs/train_vae_aux100.out
...
: "${STEPS:=100000}"; OVERRIDES="model.use_energy=false loss.aux_ce_weight=100 train.out_dir=/scratch/Projects/CFP-03/CFP03-CF-130/yuchen.yan/models/pe_vae_aux100"
nvidia-smi
