...
nvidia-smi
python -u baselines.py --style vae --set train.max_steps=100000 train.out_dir=/scratch/Projects/CFP-03/CFP03-CF-130/yuchen.yan/models/bl_vae
