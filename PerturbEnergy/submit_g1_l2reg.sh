...
: "${STEPS:=100000}"; OVERRIDES="optim.energy_l2_reg=0.1 train.out_dir=/scratch/Projects/CFP-03/CFP03-CF-130/yuchen.yan/models/perturbenergy_l2reg"
nvidia-smi
