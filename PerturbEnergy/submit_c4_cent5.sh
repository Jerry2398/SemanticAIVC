...
: "${STEPS:=100000}"; OVERRIDES="optim.energy_l2_reg=0.1 loss.contrast_mode=centroid loss.contrast_weight=5.0 train.out_dir=/scratch/Projects/CFP-03/CFP03-CF-130/yuchen.yan/models/pe_con_cent5"
nvidia-smi
