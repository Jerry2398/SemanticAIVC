...
#PBS -j oe
#PBS -o logs/train_c3_cent05.out
...
: "${STEPS:=100000}"; OVERRIDES="optim.energy_l2_reg=0.1 loss.contrast_mode=centroid loss.contrast_weight=0.5 train.out_dir=/scratch/Projects/CFP-03/CFP03-CF-130/yuchen.yan/models/pe_con_cent05"
nvidia-smi
